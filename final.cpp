    ...
    if (!curNode->isleaf) {
        ...
        for (int i = 0 ;i<curNode->record.size();i++) {
            if (k == get<0>(curNode->record.at(i))) {
                //cout<<get<1>(curNode->record.at(i))<<endl;
    ...
    if (!curNode->isleaf) {
        ...
        while (flag == 0 && curNode != NULL) {
            for (int i=x ; i<curNode->record.size();i++) {
                if (get<0>(curNode->record.at(i)) <= l) {
                    //cout << "( " <<get<0>(curNode->record.at(i))<<" , "<< get<1>(curNode->record.at(i))<< ") \t";
...
int main(int argc, char *argv[]) {
    ...
    // insertNode(rootNode,5,"abc");
    // insertNode(rootNode,6,"def");
    // insertNode(rootNode,7,"ghi");
    // insertNode(rootNode,4,"jkl");
    // insertNode(rootNode,3,"jkl");
    // insertNode(rootNode,4.5,"asdj");
    // insertNode(rootNode,8,"abc");
    // insertNode(rootNode,2,"xyz");
    // insertNode(rootNode,1,"xyz");
    // insertNode(rootNode,2.5,"pqr");
    // insertNode(rootNode,9,"val");


    /* TESTING BLOCK ONLY THIS IS FOR ODD TREES

    cout<< "Main function printers" << endl;
    cout << rootNode->keys.at(0)<<endl;
    cout << rootNode->children.at(0)->keys.at(0)<<endl;
    
    
    
    
    cout << rootNode->children.at(1)->keys.at(0)<<endl;
    
    //-------FOR EVEN TREES
    // cout << rootNode->children.at(0)->keys.at(1)<<endl;
    // cout<<get<0>(rootNode->children.at(0)->children.at(0)->record.at(0))<<endl;
    // cout<<get<0>(rootNode->children.at(0)->children.at(0)->record.at(1))<<endl;
    // cout<<get<0>(rootNode->children.at(0)->children.at(0)->record.at(2))<<endl;
    // cout<<get<0>(rootNode->children.at(0)->children.at(1)->record.at(0))<<endl;
    // cout<<get<0>(rootNode->children.at(0)->children.at(1)->record.at(1))<<endl;
    // cout<<get<0>(rootNode->children.at(0)->children.at(2)->record.at(0))<<endl;
    // cout<<get<0>(rootNode->children.at(0)->children.at(2)->record.at(1))<<endl;
    // cout<<get<0>(rootNode->children.at(1)->children.at(0)->record.at(0))<<endl;
    // cout<<get<0>(rootNode->children.at(1)->children.at(0)->record.at(1))<<endl;
    // cout<<get<0>(rootNode->children.at(1)->children.at(1)->record.at(0))<<endl;
    // cout<<get<0>(rootNode->children.at(1)->children.at(1)->record.at(1))<<endl;

    //------ even testing ended
    
    
    cout << rootNode->children.at(0)->children.at(0)->keys.at(0)<<endl;
    cout << rootNode->children.at(0)->children.at(1)->keys.at(0)<<endl;
    cout << rootNode->children.at(1)->children.at(0)->keys.at(0)<<endl;
    cout << rootNode->children.at(1)->children.at(1)->keys.at(0)<<endl;
    cout << get<0>(rootNode->children.at(0)->children.at(0)->children.at(0)->record.at(0))<<endl;
    cout << get<0>(rootNode->children.at(0)->children.at(0)->children.at(1)->record.at(0))<<endl;
    cout << get<0>(rootNode->children.at(0)->children.at(1)->children.at(0)->record.at(0))<<endl;
    cout << get<0>(rootNode->children.at(0)->children.at(1)->children.at(0)->record.at(1))<<endl;
    cout << get<0>(rootNode->children.at(0)->children.at(1)->children.at(1)->record.at(0))<<endl;
    
    cout << get<0>(rootNode->children.at(1)->children.at(0)->children.at(0)->record.at(0))<<endl;
    cout << get<0>(rootNode->children.at(1)->children.at(0)->children.at(1)->record.at(0))<<endl;
    cout << get<0>(rootNode->children.at(1)->children.at(1)->children.at(0)->record.at(0))<<endl;
    cout << get<0>(rootNode->children.at(1)->children.at(1)->children.at(1)->record.at(0))<<endl;
    cout << get<0>(rootNode->children.at(1)->children.at(1)->children.at(1)->record.at(1))<<endl;
    ...
    // cout<<"travelling back"<<endl;

    //search(rootNode,4);
    //search(rootNode,4,8);
    // cout << "Hello World";
    // ifstream file("poop.txt");
    // string str;
